...
export class AdminMatchManagerTableService implements TableService {
  ...
  actions: TableAction[] = [
    ...
    { class: 'btn-dark', icon: 'fa fa-snowflake-o', text: 'Goals', type: TableActionType.NavigateToMatchGoals },
    { class: 'btn-dark', icon: 'fa fa-users', text: 'Cards', type: TableActionType.NavigateToMatchCards },
